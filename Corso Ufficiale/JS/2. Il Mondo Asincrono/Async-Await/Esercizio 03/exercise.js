/*In questo esercizio, come nel precendente andremo a simulare il 
caricamento di moduli di un veicolo spaziale in modo asincrono e 
...
Gestisci eventuali errori nel caricamento dei moduli stampando 
in console "Impossibile lanciare il veicolo spaziale a causa di errori nei moduli."
...
async function lanciaVeicoloSpaziale(){
    try {
        const loadA = await caricaModulo('A');
        console.log(loadA);
        const loadB = await caricaModulo('B');
        console.log(loadB);
        const loadC = await caricaModulo('C');
        console.log(loadC);
