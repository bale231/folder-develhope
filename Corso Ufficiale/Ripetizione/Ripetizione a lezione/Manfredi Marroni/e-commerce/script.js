...
let btnMenClothing = document.getElementById('men-clothing');
let btnWomenClothing = document.getElementById('women-clothing');
let btnJewelery = document.getElementById('jewelery');

async function receivedProducts() {
  try {
    ...
    data.forEach(product => {
      btnElectronics.addEventListener('click', () => {
        if (product.category === "electronics") {
          ...
          containerAll.appendChild(productCard);
        }
      })
      btnMenClothing.addEventListener('click', () => {
      ...
      btnWomenClothing.addEventListener('click', () => {
